...
origins = ['http://localhost','http://localhost:3000','http://127.0.0.1:5173', 'http://16.171.39.45', 'http://16.171.39.45:8000', 'http://16.171.39.45:3000', 'http://16.171.39.45:5173','https://test.lawnmower.publicvm.com']
app.add_middleware(
    CORSMiddleware,
